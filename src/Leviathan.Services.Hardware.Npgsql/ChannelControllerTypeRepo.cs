...
namespace Leviathan.Services.Hardware.Npgsql.Modules {
	public class ChannelControllerTypeRepo : IListRepository<ChannelControllerTypeInfo, int> {
		...
		public ChannelControllerTypeInfo Create(ChannelControllerTypeInfo item) {
